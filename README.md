...
У меня не находило роль вектор, как исправить это?

В galaxy я не публиковал и в ваших примерах molecule работает находясь в папке роли.
...
## Задание 3 и Задание 4 и Задание 5
...
## Задание 2
```
docker run --privileged=True -v /home/anton-user/vector-role:/opt/vector-role -w /opt/vector-role -it aragast/netology:latest /bin/bash
```
